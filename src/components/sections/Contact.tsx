...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hola Videsol! Me llamo ${form.name}. ${form.message}`;
    window.open(`https://wa.me/59845225411?text=${encodeURIComponent(text)}`, "_blank");
    setSent(true);
    ...
    <section id="contacto" ref={sectionRef} className="bg-surface py-24 lg:py-32">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-slate-900">¿Hablamos?</h2>
          <p className="text-slate-500 mt-3 max-w-md mx-auto text-sm">
            Escribinos o visitanos. Estamos para ayudarte a encontrar tu próximo vehículo.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="contact-right">
            ...
            >
              <div className="mb-2">
                <h3 className="text-slate-900 font-black text-xl">Envianos tu consulta</h3>
              ...
              {[
                ...
                { id: "phone", label: "Teléfono (opcional)", type: "tel",  placeholder: "Tu teléfono o WhatsApp", required: false },
              ].map((f) => (
                <div key={f.id}>
